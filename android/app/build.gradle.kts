...
android {
  ...
  defaultConfig {
    ...
    minSdk = 26
    targetSdk = 36
    versionCode = providers.gradleProperty("piDroidVersionCode").getOrElse("9").toInt()
    versionName = providers.gradleProperty("piDroidVersionName").getOrElse("0.3.0-internal.9")
  }
