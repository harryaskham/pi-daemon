...
- [x] `bd-1dc765` — P1 production interactivity hotfix: constrain the lone
...
- [x] `bd-7de9ec` — visual, performance, security, dual-mode, soak and release
  acceptance; depends on live UI, workspace, TUI core/grid, and lifecycle.
- [x] `bd-ba3623` — parent Dash epic; depends only on `bd-7de9ec` so it closes
