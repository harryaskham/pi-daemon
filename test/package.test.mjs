...
test("schema conformance uses the audited exact Ajv pin without $data", async () => {
  ...
  for (const file of [
    ...
    "test/extension-view-contract.test.mjs",
    "test/dashboard-session-draft-contract.test.mjs",
...
test(
  ...
  async (t) => {
    ...
    for (const required of [
      ...
      "dist/extension-view-contract.js",
      "dist/extension-view-contract.d.ts",
      "dist/extension-view-fixtures.js",
      "dist/extension-view-fixtures.d.ts",
      ...
      "dist/dashboard-identity.js",
      "dist/dashboard-identity.d.ts",
      "dist/dashboard-identity-config.js",
      "dist/dashboard-identity-config.d.ts",
      "dist/installed-package-resources.js",
      "dist/installed-package-resources.d.ts",
      ...
      "dist/dashboard-authorization-contract.js",
      "dist/dashboard-authorization-contract.d.ts",
      "dist/dashboard-controller-coordinator.js",
      "dist/dashboard-controller-coordinator.d.ts",
      ...
      "dist/extension-view.schema.json",
      "dist/dashboard-api.openapi.json",
      "dist/dashboard-session-draft-contract.js",
    ...
    await writeFile(
      ...
      [
        ...
        'import { EXTENSION_VIEW_VERSION, parseExtensionViewDocument } from "@harryaskham/pi-daemon/extension-view-contract";',
        ...
        'import { RemoteDashboardBackend } from "@harryaskham/pi-daemon/dashboard-remote-backend";',
        ...
        'import { createDashboardIdentityProvider } from "@harryaskham/pi-daemon/dashboard-identity-config";',
        'import { resolveInstalledPiPackageResources } from "@harryaskham/pi-daemon/installed-package-resources";',
        ...
        'import { dashboardControllerEtag } from "@harryaskham/pi-daemon/dashboard-authorization-contract";',
        'import { DashboardControllerCoordinator } from "@harryaskham/pi-daemon/dashboard-controller-coordinator";',
        ...
        'import extensionViewSchema from "@harryaskham/pi-daemon/extension-view.schema.json" with { type: "json" };',
